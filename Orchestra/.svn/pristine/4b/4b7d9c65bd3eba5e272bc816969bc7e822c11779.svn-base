...
namespace Messaging.MSMQ_MT
{
    ...
    /// Consumes All
    /// </summary>
    public class ConsumesAll<T> : Consumes<T>.All where T : class
    {
    ...
    /// Consumes Selected
    /// </summary>
    public class ConsumesSelected<T> : Consumes<T>.Selected where T : class
    {
    ...
    /// Consumes Context
    /// </summary>
    public class ConsumesContext<T> : Consumes<T>.Context where T : class
    {
    ...
    public class ConsumeContext<T> : CMSG.IConsumeContext<T> where T : class
    {
